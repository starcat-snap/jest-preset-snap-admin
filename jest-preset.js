...
module.exports = {
  ...
  moduleNameMapper: {
    "\\.(css|less|scss)$": resolve(
      join(__dirname, "@tool/__mocks__/styleMock.js")
    ),
    "^src(.*)$": `${process.env.ADMIN_PATH}/src$1`,
    // Quick fix to avoid mixing of es modules and umd on webpack builds
    "^@snap-admin/admin-extension-sdk/es(.*)$":
      "@snap-admin/admin-extension-sdk/umd$1",
    "^lodash-es$": "lodash",
  },
  ...
  transform: {
    ...
    "^.+(\\.twig|\\.html)$": resolve(
      join(__dirname, "@tool/twig-to-vue-transformer/index.js")
    ),
  },
  ...
  setupFilesAfterEnv: [
    ...
    resolve(join(__dirname, "@tool/setup-env-for-snap.js")),
  ],
